...
const collegeDetails = async function (req, res) {
    ...
    let savedData = await collegeModel.findOne({_id: neededId}).select({name:1, fullName:1, logoLink:1, _id:0,interns:1})
    let finalData = savedData.toObject()
    finalData.interns = allTheInterns;
